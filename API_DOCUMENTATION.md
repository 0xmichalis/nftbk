...
nftbk-cli --server-mode --server-address https://backup-server.com

# List existing backups on server
nftbk-cli --server-mode --list --server-address https://backup-server.com

# Force rerun completed backup
nftbk-cli --server-mode --force
```
...
```bash
# Required for Alchemy RPC endpoints
...
- Backup files are saved with appropriate permissions
...
### Data Privacy
- NFT metadata may contain personal information
- Backup archives should be stored securely
- Access logs should be monitored and rotated

---

**Confidence Score: 9/10**

This documentation provides comprehensive coverage of all public APIs, functions, and components in the NFTBK project. It includes detailed examples, configuration instructions, and security considerations. The score reflects high confidence based on thorough code exploration, though some implementation details may evolve as the project develops.